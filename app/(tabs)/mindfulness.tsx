...
import { Smile, Mic, AudioLines, Square, Sparkles, Plus, Leaf, Angry, Meh, Frown } from 'lucide-react-native';
...
export default function MindfulnessScreen() {
  ...
  return (
    <View style={[dynamic.container, { paddingTop: insets.top }]}>
      <ScrollView style={dynamic.scrollView} showsVerticalScrollIndicator={false} testID="mindfulness-scroll">
        <AnimatedFadeIn delay={50}>
          <View style={dynamic.header}>
            <Text style={dynamic.title}>Mindfulness</Text>
